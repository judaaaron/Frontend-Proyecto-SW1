...
const CartScreen = ({ navigation }) => {
    ...
    React.useEffect(() => {
        ...
        currentItems.forEach((element) => {
            ...
            subtotalAcum += element.subNoISV;
        });
        setTotal(totalAcum);
        setSubtotal(subtotalAcum);
    }, [dataCart]);
    ...
    React.useEffect(() => {
        ...
        showMessage({
            message: "Orden.",
            description: orderResponse['status'] == 'success' ? "Orden ha sido procesada" : "Ocurrió un error inesperado. Por favor vuelva a intentar.",
    ...
    const CartCard = ({
        ...
        return ( <
            ...
            { /* {data.productName} */ } { /* BACAOLIVER */ } { name } <
            /Text> <
            View style = {
                {
                    marginTop: 4,
            ...
            Precio: L. { precio % 1 == 0 ? precio.toFixed(2) : precio } { /* Ancalmo */ } <
            /Text> <
            /View> <
            /View> <
            View style = {
            ...
            /View> { /* textooooooo */ } {
                ...
                recomendado &&
                    ...
                    <
                    ExtraView style = {
                        { right: 85, backgroundColor: Colors.gray } } >
                    <
                    ExtraText style = {
                        { backgroundColor: Colors.gray } } > Los usuarios también llevan: < /ExtraText> <
                    TextLink style = {
                        { borderRadius: 10, borderColor: recomendado.color, backgroundColor: Colors.gray } }
                onPress = {
                        () => {
                            navigation.navigate("DetalleProductsAncalmo", {
                                id: recomendado.id,
                    ...
                    TextLinkContent style = {
                        { backgroundColor: Colors.gray } } > { recomendado.nombre } < /TextLinkContent> <
                    /TextLink> <
                    /ExtraView>
            }
    ...
    return ( <
        > {
            dataCart.length > 0 ? ( <
                ...
                L. { subtotal % 1 == 0 ? subtotal.toFixed(2) : subtotal } <
                /Text>
                ...
                <
                Text style = {
                    { fontWeight: "bold", color: Colors.blue, marginBottom: 40 } } >
                Actualmente no tienes productos en carrito. <
                /Text> <
                PageLogOferta source = { require("../assets/emptycart.png") }
                resizeMode = "cover" /
                >
                <
                View style = {
                ...
                /> <
                Text style = {
                    { fontWeight: "bold", color: Colors.blue, marginLeft: 10 } } >
