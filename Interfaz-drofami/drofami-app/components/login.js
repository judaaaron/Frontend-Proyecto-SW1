        ...
        return (
            ...
            >
                ...
                <View style={{ height: height / 3, justifyContent: 'center' }}>
                    <TapGestureHandler onHandlerStateChange={this.onStateChange}>
                        ...
                        >
                            <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Ingresar a Drofami-App</Text>
                        </Animated.View>
                    </TapGestureHandler>
                    {/* <Animated.View
            style={{
          ...
          >
                    ...
                    >
                        ...
                        <TextInput placeholder="cliente@ejemplo.com" style={styles.textInput}
                            placeholderTextColor="black">
                        </TextInput>
                        <TextInput placeholder="token" style={styles.textInput}
                            placeholderTextColor="black">
                        </TextInput>
                        <Animated.View style={styles.button}>
                            <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Acceder</Text>
